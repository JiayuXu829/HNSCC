...
\flushbottom
\begin{document}
\title[Clinically anchored multimodal survival prediction]{Clinically anchored survival prediction with incomplete and unreliable multimodal evidence in head and neck cancer}
...
\midrule
Clinical anchor model (CAM) & 0.1247 & 0.644 & 0.662 & 0.623 & 100\% & reference\\
Shrinkage-controlled residual fusion (SCRF) & 0.1243 & 0.666 & 0.683 & 0.634 & 100\% & $+0.0098$\\
\bottomrule
\end{tabularx}
\end{table*}
...
The expanded published-method benchmark placed SCRF against fourteen survival and multimodal-fusion families on the same five repetition seeds, outer-fold assignments, 610 patients and 24-month estimand (Table~\ref{tab:published_benchmark}). The benchmark was explicitly post-hoc, did not access confirmation-cohort outcomes and did not retune SCRF. Random survival forests gave the strongest mean discrimination (Uno C 0.680, AUC 0.696 and Harrell C 0.648), whereas elastic-net Cox gave the lowest mean IPCW Brier score (0.1192). Among the fusion-family adaptations used by the two recent papers, masked attention gave Uno C 0.672, bilinear fusion gave Brier 0.1239, and SCRF gave Uno C 0.666 with Brier 0.1243. SCRF exceeded early, late, HAF and missing-aware intermediate fusion across all four performance measures while retaining exact clinical fallback and pattern-level safety. These findings position SCRF as a competitive safeguarded fusion pathway rather than an unconstrained universal winner.
...
\addlinespace[2pt]
Clinical Cox proportional hazards \cite{cox1972} & \makecell{0.1217\\{\scriptsize(0.0011)}} & \makecell{0.660\\{\scriptsize(0.007)}} & \makecell{0.678\\{\scriptsize(0.007)}} & \makecell{0.631\\{\scriptsize(0.005)}} & 100\%\\
Elastic-net Cox \cite{simon2011} & \makecell{\textbf{0.1192}\\{\scriptsize\textbf{(0.0017)}}} & \makecell{0.668\\{\scriptsize(0.005)}} & \makecell{0.681\\{\scriptsize(0.006)}} & \makecell{0.634\\{\scriptsize(0.006)}} & 100\%\\
Random survival forest \cite{ishwaran2008} & \makecell{0.1213\\{\scriptsize(0.0007)}} & \makecell{\textbf{0.680}\\{\scriptsize\textbf{(0.009)}}} & \makecell{\textbf{0.696}\\{\scriptsize\textbf{(0.010)}}} & \makecell{\textbf{0.648}\\{\scriptsize\textbf{(0.006)}}} & 100\%\\
Gradient boosting survival \cite{hothorn2006} & \makecell{0.1234\\{\scriptsize(0.0008)}} & \makecell{0.674\\{\scriptsize(0.011)}} & \makecell{0.688\\{\scriptsize(0.013)}} & \makecell{0.642\\{\scriptsize(0.007)}} & 100\%\\
XGBoost with Cox objective \cite{chen2016} & \makecell{0.1221\\{\scriptsize(0.0006)}} & \makecell{0.663\\{\scriptsize(0.009)}} & \makecell{0.677\\{\scriptsize(0.010)}} & \makecell{0.628\\{\scriptsize(0.008)}} & 100\%\\
\midrule
\multicolumn{6}{l}{\itshape Established neural survival comparators (2018--2021)}\\
\addlinespace[2pt]
DeepSurv \cite{katzman2018} & \makecell{0.1626\\{\scriptsize(0.0090)}} & \makecell{0.639\\{\scriptsize(0.030)}} & \makecell{0.650\\{\scriptsize(0.034)}} & \makecell{0.603\\{\scriptsize(0.015)}} & 100\%\\
DeepHit \cite{lee2018} & \makecell{0.1458\\{\scriptsize(0.0089)}} & \makecell{0.623\\{\scriptsize(0.019)}} & \makecell{0.635\\{\scriptsize(0.022)}} & \makecell{0.594\\{\scriptsize(0.010)}} & 100\%\\
MultiSurv, adapted \cite{valesilva2021} & \makecell{0.1261\\{\scriptsize(0.0021)}} & \makecell{0.626\\{\scriptsize(0.021)}} & \makecell{0.639\\{\scriptsize(0.023)}} & \makecell{0.597\\{\scriptsize(0.014)}} & 100\%\\
\pagebreak[4]
\midrule
\multicolumn{6}{l}{\itshape Fusion-family baselines mirrored from recent protocols (2026)}\\
\addlinespace[2pt]
Early feature fusion, adapted \cite{zheng2026,ruffini2026} & \makecell{0.1354\\{\scriptsize(0.0032)}} & \makecell{0.636\\{\scriptsize(0.010)}} & \makecell{0.643\\{\scriptsize(0.011)}} & \makecell{0.599\\{\scriptsize(0.005)}} & 100\%\\
Late decision fusion, adapted \cite{zheng2026,ruffini2026} & \makecell{0.1694\\{\scriptsize(0.0072)}} & \makecell{0.571\\{\scriptsize(0.024)}} & \makecell{0.573\\{\scriptsize(0.026)}} & \makecell{0.552\\{\scriptsize(0.019)}} & 100\%\\
Masked attention fusion, adapted \cite{zheng2026} & \makecell{0.1245\\{\scriptsize(0.0012)}} & \makecell{0.672\\{\scriptsize(0.010)}} & \makecell{0.686\\{\scriptsize(0.013)}} & \makecell{0.637\\{\scriptsize(0.011)}} & 100\%\\
Bilinear interaction fusion, adapted \cite{zheng2026} & \makecell{0.1239\\{\scriptsize(0.0005)}} & \makecell{0.663\\{\scriptsize(0.009)}} & \makecell{0.674\\{\scriptsize(0.010)}} & \makecell{0.629\\{\scriptsize(0.003)}} & 100\%\\
\midrule
\multicolumn{6}{l}{\itshape Recent missing-modality comparators (2026)}\\
\addlinespace[2pt]
Missing-aware intermediate fusion, adapted \cite{ruffini2026} & \makecell{0.1332\\{\scriptsize(0.0009)}} & \makecell{0.556\\{\scriptsize(0.010)}} & \makecell{0.549\\{\scriptsize(0.011)}} & \makecell{0.539\\{\scriptsize(0.005)}} & 100\%\\
Heterogeneous aligned fusion, adapted \cite{zheng2026} & \makecell{0.1295\\{\scriptsize(0.0008)}} & \makecell{0.573\\{\scriptsize(0.029)}} & \makecell{0.574\\{\scriptsize(0.033)}} & \makecell{0.554\\{\scriptsize(0.018)}} & 100\%\\
\midrule
\multicolumn{6}{l}{\itshape Proposed method}\\
\addlinespace[2pt]
\textbf{PATTERN-Surv-HN (SCRF; ours)} & \makecell{0.1243\\{\scriptsize(0.0033)}} & \makecell{0.666\\{\scriptsize(0.017)}} & \makecell{0.683\\{\scriptsize(0.018)}} & \makecell{0.634\\{\scriptsize(0.019)}} & 100\%\\
\end{longtable}
\par\vspace{5pt}
...
Raw SCRF showed mild under-dispersion in the development absolute-risk diagnostic (calibration slope 0.826; calibration-in-the-large $+0.012$). The separately evaluated development calibration bridge used a fixed positive slope of 0.90 and a cross-fitted weighted-log-loss intercept on the logit scale. It preserved ranking and 100\% coverage while moving calibration-in-the-large to $-0.004$ and slope to 0.882 (Fig.~\ref{fig:bridge}). Its IPCW Brier penalty was $+0.0001$, within the development gate of $+0.0005$, and its worst supported-pattern regret was $+0.0042$, below $+0.005$.

The locked secondary bridge analysis then applied the already frozen transformation without confirmation-cohort refitting, after the raw-SCRF confirmation outcomes had been unsealed. Ranking and coverage remained preserved, but IPCW Brier worsened by $+0.0011$, absolute calibration-in-the-large error worsened by $+0.0042$, and absolute calibration-slope error worsened by $+0.168$. Thus, the development calibration gain did not transport; the bridge remains development-only and is not a confirmed calibration layer.
...
After the SCRF protocol, input manifest, dependency lock and patient-level predictions had been frozen, confirmation outcomes were unsealed in 152 HANCOCK patients with 40 deaths. The primary readout was raw SCRF, not the calibration bridge or router. SCRF retained 100\% coverage and had favourable point estimates for Uno C (0.804 versus 0.783), IPCW Brier (0.1312 versus 0.1364), AUC$_{24}$ (0.814 versus 0.801) and Harrell C (0.753 versus 0.733; Table~\ref{tab:confirmation} and Fig.~\ref{fig:confirmation}).

Patient-level stratified bootstrap intervals crossed zero for every principal delta. For example, the mean delta Uno C was $+0.022$ (95\% interval $-0.026$ to $+0.071$) and mean delta IPCW Brier was $-0.0052$ ($-0.0128$ to $+0.0022$). The locked result therefore supports a positive directional raw-SCRF confirmation signal, not definitive superiority or clinical utility.
...
\midrule
Uno C$_{24}$ & 0.783 & 0.804 & $+0.022$ & $+0.022$ ($-0.026$, $+0.071$)\\
IPCW Brier$_{24}$ & 0.1364 & 0.1312 & $-0.0052$ & $-0.0052$ ($-0.0128$, $+0.0022$)\\
AUC$_{24}$ & 0.801 & 0.814 & $+0.013$ & $+0.013$ ($-0.041$, $+0.068$)\\
Harrell C & 0.733 & 0.753 & $+0.020$ & $+0.020$ ($-0.017$, $+0.061$)\\
Coverage & 100\% & 100\% & 0 & --\\
\bottomrule
\end{tabular}
\end{table*}
...
Each usable optional modality was represented as an unordered token containing measurements, modality identity, usability/status indicators and quality features. A permutation-invariant Deep Sets residual encoder processed the available token set \cite{zaheer2017,lee2019}:
\begin{equation}
...
\end{equation}
IPCW Brier scores, Uno C and time-dependent AUC addressed censoring \cite{graf1999,gerds2006,heagerty2000,uno2011}. Bootstrap resampling was performed at patient level, preserving the paired nature of model comparisons. Two-sided 95\% intervals are percentile bootstrap intervals from the prespecified replicate sets. Publication-facing performance estimates and confidence limits are rounded to three decimals; Brier scores and changes smaller than 0.01 are shown to four decimals when three-decimal rounding would obscure the comparison. All calculations, model selection and safety gates used the unrounded values.
...
The frozen exploratory gate required complete coverage, structural fallback safety, bounded Brier deterioration, bounded calibration deterioration and at least one reproducible incremental-value path. Observed worst supported-pattern Brier regret was $+0.0027$ against a $+0.020$ ceiling. Mean absolute calibration-in-the-large deterioration was $+0.049$ against a $+0.100$ ceiling, and mean absolute calibration-slope-error deterioration was $-0.084$ against a $+0.150$ ceiling. Both probability-error and discrimination paths met their seed-stability requirements, so the frozen gate returned \texttt{T1R\_EARNS\_COMPLEXITY}.
...
SCRF improved every aggregate discrimination measure and the mean 24-month IPCW Brier score in HANCOCK development (Table~\ref{tab:supptable1}). The mean Uno C gain was $+0.021$ and was favourable in all five seeds. Coverage remained 100\%, the empty-set fallback error was zero, and the worst supported-pattern Brier regret was $+0.0098$, below the $+0.020$ safety boundary.

The U5R7 bridge moved calibration-in-the-large from $+0.012$ to $-0.004$ and calibration slope from 0.826 to 0.882 (Table~\ref{tab:supptable2}). Ranking and coverage were preserved. The global Brier change was $+0.0001$, within the $+0.0005$ gate, and worst supported-pattern regret was $+0.0042$, below the $+0.005$ gate. Thus, the development bridge improved the probability scale without changing patient ordering or availability.
...
\bottomrule
\endlastfoot
IPCW Brier at 24 months & 0.1247 & 0.1243 & $-0.0004$ & Lower probabilistic error\\
Uno C at 24 months & 0.644 & 0.666 & $+0.021$ & Improved discrimination\\
Time-dependent AUC at 24 months & 0.662 & 0.683 & $+0.020$ & Improved horizon ranking\\
Harrell C & 0.623 & 0.634 & $+0.011$ & Improved overall ranking\\
Coverage & 100\% & 100\% & 0 & Full output availability\\
Empty-set fallback error & 0 & 0 & 0 & Exact clinical fallback\\
Worst supported-pattern Brier regret & Reference & $+0.0098$ & $+0.0098$ & Below $+0.020$ boundary\\
...
\bottomrule
\endlastfoot
Clinical anchor model (CAM) & 0.1247 & 0.644 & 0.662 & 0.623\\
Unshrunk residual fusion (URF) & 0.1265 & 0.646 & 0.659 & 0.628\\
Shrinkage-controlled residual fusion (SCRF) & \textbf{0.1243} & \textbf{0.666} & \textbf{0.683} & \textbf{0.634}\\
\addlinespace[3pt]
URF minus CAM & $+0.0018$ & $+0.002$ & $-0.003$ & $+0.005$\\
SCRF minus CAM & $-0.0004$ & $+0.021$ & $+0.020$ & $+0.011$\\
\end{longtable}
\endgroup
...
\bottomrule
\endlastfoot
IPCW Brier at 24 months & 0.1266 & 0.1268 & $+0.0001$ & Within $+0.0005$ gate\\
Calibration-in-the-large & $+0.012$ & $-0.004$ & $-0.015$ & Absolute error improved by 0.008\\
Calibration slope & 0.826 & 0.882 & $+0.056$ & Absolute error improved by 0.056\\
Worst supported-pattern Brier regret & Reference & $+0.0042$ & $+0.0042$ & Below $+0.005$ gate\\
...
\bottomrule
\endlastfoot
Uno C & 0.783 & 0.804 & $+0.022$ & Favourable point estimate\\
IPCW Brier & 0.1364 & 0.1312 & $-0.0052$ & Favourable point estimate\\
Time-dependent AUC & 0.801 & 0.814 & $+0.013$ & Favourable point estimate\\
Harrell C & 0.733 & 0.753 & $+0.020$ & Favourable point estimate\\
Calibration-in-the-large & 0.211 & 0.116 & $-0.095$ & Closer to zero\\
Calibration slope & 1.945 & 1.501 & $-0.444$ & Closer to one\\
Coverage & 100\% & 100\% & 0 & Preserved\\
\end{longtable}
\endgroup

Every router improved on CAM at the point estimate, while direct raw SCRF remained the strongest overall policy (Table~\ref{tab:supptable4} and Fig.~\ref{fig:supp_router}). The best router used reliability features at threshold 0.60: delta Brier versus CAM was $-0.0005$, and its bootstrap interval was approximately $-0.0016$ to $+0.0008$. These results show that repetition-level stability contains useful routing information and support further development of selective prediction at matched coverage.
...
\bottomrule
\endlastfoot
CAM & 0.0\% & 0.1239 & 0 & $+0.0012$ & 0.867\\
Raw SCRF & 100.0\% & 0.1228 & $-0.0012$ & 0 & 1.000\\
Core router, $q\ge0.40$ & 66.1\% & 0.1235 & $-0.0004$ & $+0.0008$ & 0.945\\
Core router, $q\ge0.50$ & 54.1\% & 0.1235 & $-0.0004$ & $+0.0007$ & 0.939\\
Core router, $q\ge0.60$ & 40.3\% & 0.1236 & $-0.0003$ & $+0.0008$ & 0.928\\
Reliability router, $q\ge0.40$ & 67.0\% & 0.1236 & $-0.0003$ & $+0.0009$ & 0.946\\
Reliability router, $q\ge0.50$ & 54.8\% & 0.1235 & $-0.0004$ & $+0.0007$ & 0.938\\
Reliability router, $q\ge0.60$ & 42.6\% & 0.1234 & $-0.0005$ & $+0.0007$ & 0.929\\
\end{longtable}
\endgroup
...
\bottomrule
\endlastfoot
C1 & 0.0958 & 0.807 & 0.819 & 0.796 & $-0.097$ & 1.951\\
C2 & 0.0907 & 0.807 & 0.818 & 0.798 & $-0.044$ & 1.139\\
C3 & 0.0985 & 0.771 & 0.781 & 0.762 & $-0.100$ & 1.268\\
C4 & 0.0974 & 0.779 & 0.788 & 0.769 & $-0.075$ & 1.472\\
\end{longtable}
\endgroup
...
\bottomrule
\endlastfoot
IPCW Brier at 24 months & 0.2218 & 0.2181 & $-0.0037$ & 4/5\\
Harrell C & 0.577 & 0.606 & $+0.029$ & 5/5\\
Uno C at 24 months & 0.565 & 0.597 & $+0.032$ & 5/5\\
Time-dependent AUC at 24 months & 0.557 & 0.600 & $+0.043$ & 5/5\\
\end{longtable}
\endgroup
...
A single tSCRF model fitted to the complete TCGA-HNSC development cohort showed favourable Brier and discrimination changes in both GEO cohorts (Table~\ref{tab:supptable8} and Fig.~\ref{fig:supp_geo}). In GSE65858, Uno C increased from 0.584 to 0.646. In GSE41613, the applied clinical anchor had no cross-patient variation, whereas tSCRF restored patient-level ordering, with Harrell C 0.626 and 24-month AUC 0.634. Calibration slopes above one indicate compressed predicted-risk dispersion, making cohort-level recalibration a constructive next step for prospective absolute-risk reporting.
...
IPCW Brier at 24 months & 0.1952 & 0.1951 & $-0.0001$\\
Harrell C & 0.582 & 0.645 & $+0.063$\\
Uno C at 24 months & 0.584 & 0.646 & $+0.062$\\
Time-dependent AUC at 24 months & 0.589 & 0.651 & $+0.062$\\
Calibration-in-the-large & $-0.764$ & $-0.832$ & $-0.068$\\
Calibration slope & 1.707 & 1.942 & $+0.234$\\
\multicolumn{4}{l}{\textbf{GSE41613 (n=97; 51 events)}}\\
IPCW Brier at 24 months & 0.2657 & 0.2586 & $-0.0071$\\
Harrell C & 0.500 & 0.626 & $+0.126$\\
Uno C at 24 months & 0.500 & 0.616 & $+0.116$\\
Time-dependent AUC at 24 months & 0.500 & 0.634 & $+0.134$\\
Calibration-in-the-large & $-0.274$ & $-0.265$ & $+0.0089$\\
Calibration slope & -- & 1.939 & --\\
\end{longtable}
\endgroup
...
\bottomrule
\endlastfoot
Clinical Cox PH & $+0.040$ (0.008) & 0.742 (0.054) & 0.65\\
Elastic-net Cox & $-0.019$ (0.023) & 1.009 (0.462) & 0.58\\
Random survival forest & $+0.014$ (0.010) & 1.551 (0.071) & 5.62\\
Gradient boosting survival & $-0.012$ (0.003) & 1.919 (0.163) & 1.80\\
XGBoost-Cox & $+0.038$ (0.025) & 0.720 (0.032) & 0.79\\
DeepSurv & $+0.943$ (0.269) & unstable ($>10^{10}$) & 5.60\\
DeepHit & $+0.846$ (0.278) & unstable ($>10^{10}$) & 8.27\\
MultiSurv, adapted & $+0.064$ (0.045) & 0.477 (0.082) & 3.33\\
Early feature fusion, adapted & $-0.597$ (0.066) & 0.703 (0.084) & 1.32\\
Late decision fusion, adapted & $-1.103$ (0.059) & 0.930 (1.012) & 1.99\\
Masked attention fusion, adapted & $-0.078$ (0.047) & 1.801 (0.361) & 2.50\\
Bilinear interaction fusion, adapted & $+0.067$ (0.045) & 1.154 (0.100) & 3.04\\
Missing-aware intermediate fusion, adapted & $-0.092$ (0.045) & 0.159 (0.095) & 2.94\\
Heterogeneous aligned fusion, adapted & $-0.053$ (0.060) & 0.772 (0.561) & 5.17\\
PATTERN-Surv-HN (SCRF) & $-0.017$ (0.020) & 0.851 (0.169) & --\\
\end{longtable}
\endgroup
