...
- Seeds: [17, 29, 43, 71, 101]; patient-level metric bootstrap: 1000 replicates.
...
By IPCW Brier score, the apparent best method was **C2** (Brier=0.0679, Harrell C=0.8778, AUC=0.9498). B7 coverage was 90.4%; gate actions: AUGMENT=115 (85.2%), FALLBACK=7 (5.2%), ABSTAIN=13 (9.6%).
